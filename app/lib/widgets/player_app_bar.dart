            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  //             // local isFav মান
                  //             bool isFav = media.data?.extras?['isFav'] == true;

                  //             return GestureDetector(
                  //               onTap: () {
                  //                 // সাথে সাথে toggle করে দেখাই
                  //                 media.data?.extras?['isFav'] = !isFav;

                  //                 // API call করি
                  //                 ref
                  //                     .read(favunfavProvider(
                  //                             media.data?.extras?['id'] ?? '')
                  //                         .notifier)
                  //                     .favUnFav()
                  //                     .then((_) {
                  //                   // success হলে list invalidate করি
                  //                   ref.invalidate(favListProvider);
                  //                   ref.invalidate(tracksProvider(
                  //                       media.data?.extras?['album'] ?? ''));
                  //                 }).catchError((e) {
                  //                   // ব্যর্থ হলে আবার আগের অবস্থায় ফিরিয়ে দেই
                  //                   media.data?.extras?['isFav'] = isFav;
                  //                 });
                  //               },
                  //               child: FavouriteIcon(isFavourite: isFav),
                  //             );
                  //           },
                  //         )
                  //       : const SizedBox(),
